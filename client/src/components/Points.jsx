...
const Edumpers = () => {
    ...
    const calculatePoints = async () => {
        try {
            const response = await fetch("https://green-grid-web.vercel.app/api/calculate-points", {
                method: "POST",
                headers: {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch("https://green-grid-web.vercel.app/api/validate-coupon", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleDeliverySubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://green-grid-web.vercel.app/api/submit-delivery", {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
